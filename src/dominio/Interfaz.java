...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (nombre2.equals("")){
                String Curp = d.primerLetra(apellidoP)+d.primerVocal()+d.primerLetra(apellidoM)+d.nombrePila(nombre, nombre2)+d.yearDayMonth(diaNac, mes, year)+d.sexo()+d.entidad(Estado.valueOf(entidad))+d.primer_Constante()+d.primer_ConstantSegundoApllido()+d.ConstanteNombrePlia()+d.ultimosDigitos()+d.codigoVerificador();
                vaciar();
